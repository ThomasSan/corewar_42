...
/*   Updated: 2016/12/19 17:12:27 by ybeaure          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		op_lldi(t_process *pro, t_vm *vm, char **p_val, char *p_type)
{
	...
	if (p_type[2] == REG_CODE && check_p_val(p_val[2]) && ((p_type[0] == REG_CODE && check_p_val(p_val[0])) || p_type[0] == DIR_CODE || p_type[0] == IND_CODE) && ((p_type[1] == REG_CODE && check_p_val(p_val[1])) || p_type[1] == DIR_CODE))
	{
