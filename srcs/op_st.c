...
/*   Updated: 2016/12/19 17:13:19 by ybeaure          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
else if (p_type[0] == 1 && check_p_val(p_val[0]) && p_type[1] == 1 && check_p_val(p_val[0]))
copy_registre(pro, c_single_int(p_val[1][0]) - 1, c_single_int(p_val[0][0]) - 1);
}
