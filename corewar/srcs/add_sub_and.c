...
/*   Updated: 2016/12/06 18:03:40 by ybeaure          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_add(t_vm *vm, t_process *pro, char p_code[4], int p_val[4])
{
	...
	{
		vm->champs[vm->ram[pro->pc].owner].reg[p_val[2] - 1] =
			vm->champs[vm->ram[pro->pc].owner].reg[p_val[1] - 1]
			+ vm->champs[vm->ram[pro->pc].owner].reg[p_val[0] - 1];
