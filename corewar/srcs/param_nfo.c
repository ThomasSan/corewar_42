...
/*   Updated: 2016/11/28 17:31:43 by ybeaure          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (p_code == REG_CODE && p_code == 1)
		return (1);
	if (p_code == DIR_CODE && p_code == 2 && op_tab[(int)op_code - 1].is_idx == 1)
		return (IND_SIZE);
	if (p_code == DIR_CODE && p_code == 2 && op_tab[(int)op_code - 1].is_idx == 0)
		return (DIR_SIZE);
	if (p_code == IND_CODE && p_code == 3)
		return (IND_SIZE);
	return (0);
}
